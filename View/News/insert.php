<!-- TinyMCE -->
<script type="text/javascript" src="<?php print baseurl;?>/Scripts/tiny_mce/tiny_mce.js"></script>
...
News<br>
<textarea name="News" cols="120" rows="30"><?php print $model->News; ?></textarea><br>
<br>
